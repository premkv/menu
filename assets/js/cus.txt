jQuery(document).ready(function() {
    ...
    $(".featuredProductsSlider").slick({
        ...
        var e = $(this),
            o = e.data("toast-type"),
            s = e.data("toast-icon"),
            a = (e.data("toast-position"), e.data("toast-title")),
    ...
    }), $(".select-drop").selectbox(), $(".incr-btn").on("click", function(e) {
        var o = $(this),
            s = 0,
            a = o.parent().find(".quantity").val();
        o.parent().find('.incr-btn[data-action="decrease"]').removeClass("inactive"), "increase" === o.data("action") ? s = parseFloat(a) + 1 : a > 1 ? s = parseFloat(a) - 1 : (s = 1, o.addClass("inactive")), o.parent().find(".quantity").val(s), e.preventDefault()
    });
    $("#price-range").slider({
            range: !0,
            min: 20,
            ...
            values: [20, 300],
            slide: function(e, o) {
                $("#price-amount-1").val("$" + o.values[0]), $("#price-amount-2").val("$" + o.values[1])
            }
        ...
        function(e) {
            ...
            e("#carousel").on("slide.bs.carousel", function(s) {
                var a = e(s.relatedTarget),
                    i = a.data("thumb"),
                    t = o.index(o.filter(".active").get(0));
                t > i ? (e("#thumbcarousel").one("slid.bs.carousel", function(o) {
                    e("#thumbcarousel").carousel(i)
                }), t === o.length - 1 ? e("#thumbcarousel").carousel("next") : e("#thumbcarousel").carousel(numThumbItems - 1)) : e("#thumbcarousel").carousel(i)
            })
    ...
    $("#faqAccordion .panel-heading").click(function() {
        e.removeClass("fa-chevron-down").addClass("fa-chevron-up"), $(this).find("i.fa").removeClass("fa-chevron-up").addClass("fa-chevron-down")
    });
    ...
    var s = $("#accordionTwo .panel-heading i.fa");
    $("#accordionTwo .panel-heading").click(function() {
        s.removeClass("fa-chevron-down").addClass("fa-chevron-up"), $(this).find("i.fa").removeClass("fa-chevron-up").addClass("fa-chevron-down")
    });
    var a = $("#togglesOne .panel-heading i.fa");
